      ...
      <div className="min-h-screen bg-gradient-to-br from-purple-900 via-indigo-900 to-blue-900 flex items-center justify-center px-4 py-8">
        <div className="w-full max-w-2xl">
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl shadow-2xl p-8 text-center">
            ...
            <Link
              to="/"
              className="inline-block bg-purple-600 hover:bg-purple-700 text-white px-6 py-3 rounded-lg transition-colors shadow-lg hover:shadow-xl"
            >
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-white/10 backdrop-blur-md rounded-2xl shadow-2xl p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <button
              type="submit"
              className="w-full bg-purple-600 hover:bg-purple-700 text-white py-4 rounded-lg transition-colors shadow-lg hover:shadow-xl text-lg"
            >
              Отправить отзыв
            </button>
          </form>
